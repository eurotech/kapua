...
public class DeviceMessageListener extends AbstractListener {
    ...
    public DeviceMessageListener() {
        ...
        metricDeviceUnmatchedMessage = registerCounter(DeviceManagementRegistryNotificationMetrics.METRIC_MESSAGES, DeviceManagementRegistryNotificationMetrics.METRIC_UNMATCHED, DeviceManagementRegistryNotificationMetrics.METRIC_COUNT);
