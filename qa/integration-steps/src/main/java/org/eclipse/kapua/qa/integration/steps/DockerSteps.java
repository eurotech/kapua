...
public class DockerSteps {
     ...
     * @param dockerImage              full name of image (e.g. "eclipsekapua/kapua-broker:1.6.16-SNAPSHOT")
    ...
    private ContainerConfig getDbContainerConfig() {
        ...
        return ContainerConfig.builder()
                ...
                .image("eclipsekapua/kapua-sql:1.6.16-SNAPSHOT")
                .build();
    }
    ...
    private ContainerConfig getEventBrokerContainerConfig() {
        ...
        return ContainerConfig.builder()
                ...
                .image("eclipsekapua/kapua-events-broker:1.6.16-SNAPSHOT")
                .build();
    }
